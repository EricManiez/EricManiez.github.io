...
const en = {
  ...
  'music.title': 'Music',
  'music.subtitle': 'Recordings, collaborations, and other sonic work.',
  'music.empty': 'No tracks published yet.',
...
const fr: typeof en = {
  ...
  'music.title': 'Musique',
  'music.subtitle': 'Enregistrements, collaborations et autres travaux sonores.',
  'music.empty': 'Aucun morceau publié pour le moment.',
